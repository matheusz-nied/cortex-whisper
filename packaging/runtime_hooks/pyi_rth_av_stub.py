...
Whisper Ditado always passes microphone audio to faster-whisper as a NumPy
...
def _unsupported_file_input(name):
    ...
    raise RuntimeError(
        "PyAV is intentionally excluded from Whisper Ditado release packages; "
...
if "av" not in sys.modules:
    ...
    av_stub.__file__ = "<Whisper Ditado PyAV compatibility stub>"
